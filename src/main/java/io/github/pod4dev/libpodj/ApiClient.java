...
import io.github.pod4dev.libpodj.auth.Authentication;
import io.github.pod4dev.libpodj.auth.HttpBasicAuth;
import io.github.pod4dev.libpodj.auth.HttpBearerAuth;
import io.github.pod4dev.libpodj.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/5.3.2-2/java");
    ...
    */
     ...
     * @throws io.github.pod4dev.libpodj.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.github.pod4dev.libpodj.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.github.pod4dev.libpodj.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.github.pod4dev.libpodj.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.github.pod4dev.libpodj.ApiException If the response has an unsuccessful status code or
     ...
     * @param uri URI
     * @throws io.github.pod4dev.libpodj.ApiException If fails to update the parameters
     */
     ...
     * @throws io.github.pod4dev.libpodj.ApiException If fail to serialize the request body object into a string
     */
